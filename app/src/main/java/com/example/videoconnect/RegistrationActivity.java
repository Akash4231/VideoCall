        ...
        continueAndNextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else
                {
                    ...
                    {
                        Toast.makeText(RegistrationActivity.this, "Please write the valid phone number", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            loadingBar.dismiss();
                            Toast.makeText(RegistrationActivity.this, "Congratuation, you are loggend in successfully", Toast.LENGTH_SHORT).show();
