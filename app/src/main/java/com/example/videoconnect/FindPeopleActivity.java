...
{
    private RecyclerView finfFriendList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        finfFriendList = findViewById(R.id.find_friends_list);
        finfFriendList.setLayoutManager(new LinearLayoutManager(getApplicationContext()));
    ...
    protected void onStart()
    {
        ...
        finfFriendList.setAdapter(firebaseRecyclerAdapter);
